...
public class RegPasswordActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String TAG = "RegPasswordActivity";
        ...
        FirebaseAuth.getInstance().createUserWithEmailAndPassword(email, password)
            .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                if (task.isSuccessful()) {
                    ...
                    //Toast feedback.
                    Toast.makeText(RegPasswordActivity.this, "Successfully Registered", Toast.LENGTH_LONG).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                            Toast.makeText(RegPasswordActivity.this, "addOnFailure", Toast.LENGTH_SHORT).show();
                            FirebaseAuth.getInstance().signOut();
                            //Redirect the user to the login screen
                            redirectLoginScreen();
                            }
                ...
                if (!task.isSuccessful()) {
                    //Toast feedback.
                    Toast.makeText(RegPasswordActivity.this, "Unable to Register", Toast.LENGTH_SHORT).show();
                }
                }
            });
    }
